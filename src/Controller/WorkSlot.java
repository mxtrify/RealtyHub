...
public class WorkSlot {
    ...
    public ArrayList<Property> getAllWorkSlotsMax() {
        ...
        try {
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                Property pro = new Property();//Object

                pro.setPropertytitle(resultSet.getString("propertytitle"));
                pro.setPrice(resultSet.getInt("price"));
                pro.setSeller(resultSet.getString("seller"));
                pro.setDescribe(resultSet.getString("describe1"));
                pro.setLocation(resultSet.getString("location"));
